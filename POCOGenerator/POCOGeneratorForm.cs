    ...
    public partial class POCOGeneratorForm : Form
    {
        ...
        private void chkComments_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (IsComments == false && IsCommentsWithoutNull)
            {
                ...
                chkCommentsWithoutNull.CheckedChanged -= chkCommentsWithoutNull_CheckedChanged;
        ...
        private void chkCommentsWithoutNull_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                IsComments = true;
                chkComments.CheckedChanged -= chkComments_CheckedChanged;
        ...
        private void chkNavigationProperties_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (IsNavigationProperties == false)
            {
                ...
                chkNavigationPropertiesVirtual.CheckedChanged -= chkNavigationPropertiesVirtual_CheckedChanged;
                chkNavigationPropertiesVirtual.Checked = false;
                chkNavigationPropertiesVirtual.CheckedChanged += chkNavigationPropertiesVirtual_CheckedChanged;

                IsNavigationPropertiesShowJoinTable = false;
                chkNavigationPropertiesShowJoinTable.CheckedChanged -= chkNavigationPropertiesShowJoinTable_CheckedChanged;
                chkNavigationPropertiesShowJoinTable.Checked = false;
                chkNavigationPropertiesShowJoinTable.CheckedChanged += chkNavigationPropertiesShowJoinTable_CheckedChanged;

                IsNavigationPropertiesComments = false;
                chkNavigationPropertiesComments.CheckedChanged -= chkNavigationPropertiesComments_CheckedChanged;
                chkNavigationPropertiesComments.Checked = false;
                chkNavigationPropertiesComments.CheckedChanged += chkNavigationPropertiesComments_CheckedChanged;

                IsEFForeignKey = false;
                chkEFForeignKey.CheckedChanged -= chkEFForeignKey_CheckedChanged;
                chkEFForeignKey.Checked = false;
                chkEFForeignKey.CheckedChanged += chkEFForeignKey_CheckedChanged;
            }
        ...
        private void chkNavigationPropertiesVirtual_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (IsNavigationPropertiesVirtual && IsNavigationProperties == false)
            {
                ...
                chkNavigationProperties.CheckedChanged -= chkNavigationProperties_CheckedChanged;
                chkNavigationProperties.Checked = true;
                chkNavigationProperties.CheckedChanged += chkNavigationProperties_CheckedChanged;
            }
        ...
        private void chkUpperCase_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                IsCamelCase = false;
                chkCamelCase.CheckedChanged -= chkCamelCase_CheckedChanged;
        ...
        private void chkDataContract_CheckedChanged(object sender, EventArgs e)
        {
            IsDataContract = chkDataContract.Checked;
            if (chkDataContract.Checked)
                WritePocoToEditor();
        }
        #endregion
        ...
        private void chkEF_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                IsEFColumn = false;
                chkEFColumn.CheckedChanged -= chkEFColumn_CheckedChanged;
                chkEFColumn.Checked = false;
                chkEFColumn.CheckedChanged += chkEFColumn_CheckedChanged;

                IsEFRequired = false;
                chkEFRequired.CheckedChanged -= chkEFRequired_CheckedChanged;
                chkEFRequired.Checked = false;
                chkEFRequired.CheckedChanged += chkEFRequired_CheckedChanged;

                IsEFRequiredWithErrorMessage = false;
                chkEFRequiredWithErrorMessage.CheckedChanged -= chkEFRequiredWithErrorMessage_CheckedChanged;
                chkEFRequiredWithErrorMessage.Checked = false;
                chkEFRequiredWithErrorMessage.CheckedChanged += chkEFRequiredWithErrorMessage_CheckedChanged;

                IsEFConcurrencyCheck = false;
                chkEFConcurrencyCheck.CheckedChanged -= chkEFConcurrencyCheck_CheckedChanged;
                chkEFConcurrencyCheck.Checked = false;
                chkEFConcurrencyCheck.CheckedChanged += chkEFConcurrencyCheck_CheckedChanged;

                IsEFStringLength = false;
                chkEFStringLength.CheckedChanged -= chkEFStringLength_CheckedChanged;
                chkEFStringLength.Checked = false;
                chkEFStringLength.CheckedChanged += chkEFStringLength_CheckedChanged;

                IsEFDisplay = false;
                chkEFDisplay.CheckedChanged -= chkEFDisplay_CheckedChanged;
                chkEFDisplay.Checked = false;
                chkEFDisplay.CheckedChanged += chkEFDisplay_CheckedChanged;

                IsEFDescription = false;
                chkEFDescription.CheckedChanged -= chkEFDescription_CheckedChanged;
                chkEFDescription.Checked = false;
                chkEFDescription.CheckedChanged += chkEFDescription_CheckedChanged;

                IsEFComplexType = false;
                chkEFComplexType.CheckedChanged -= chkEFComplexType_CheckedChanged;
                chkEFComplexType.Checked = false;
                chkEFComplexType.CheckedChanged += chkEFComplexType_CheckedChanged;

                IsEFIndex = false;
                chkEFIndex.CheckedChanged -= chkEFIndex_CheckedChanged;
                chkEFIndex.Checked = false;
                chkEFIndex.CheckedChanged += chkEFIndex_CheckedChanged;
        ...
        private void CheckEFCheckBox(bool otherEF)
        {
            ...
            {
                IsEF = true;
                chkEF.CheckedChanged -= chkEF_CheckedChanged;
                chkEF.Checked = true;
                chkEF.CheckedChanged += chkEF_CheckedChanged;
            }
        }
        ...
        private IPOCOIterator GetPOCOIterator(IEnumerable<IDbObjectTraverse> dbObjects, StringBuilder sb)
        {
            ...
            iterator.IsSP = IsSP;
            iterator.IsDataContract = IsDataContract;
        ...
        private void LoadOptions()
        {
            try
            {
                ...
                rdbProperties.CheckedChanged -= rdbProperties_CheckedChanged;
                rdbProperties.Checked = IsProperties;
                rdbProperties.CheckedChanged += rdbProperties_CheckedChanged;

                rdbDataMembers.CheckedChanged -= rdbDataMembers_CheckedChanged;
                rdbDataMembers.Checked = !IsProperties;
                rdbDataMembers.CheckedChanged += rdbDataMembers_CheckedChanged;

                IsVirtualProperties = options.IsVirtualProperties;
                chkVirtualProperties.CheckedChanged -= chkVirtualProperties_CheckedChanged;
                chkVirtualProperties.Checked = IsVirtualProperties;
                chkVirtualProperties.CheckedChanged += chkVirtualProperties_CheckedChanged;

                IsPartialClass = options.IsPartialClass;
                chkPartialClass.CheckedChanged -= chkPartialClass_CheckedChanged;
                chkPartialClass.Checked = IsPartialClass;
                chkPartialClass.CheckedChanged += chkPartialClass_CheckedChanged;

                IsAllStructNullable = options.IsAllStructNullable;
                chkAllStructNullable.CheckedChanged -= chkAllStructNullable_CheckedChanged;
                chkAllStructNullable.Checked = IsAllStructNullable;
                chkAllStructNullable.CheckedChanged += chkAllStructNullable_CheckedChanged;
                ...
                chkComments.CheckedChanged -= chkComments_CheckedChanged;
                chkComments.Checked = IsComments;
                chkComments.CheckedChanged += chkComments_CheckedChanged;

                IsCommentsWithoutNull = options.IsCommentsWithoutNull;
                chkCommentsWithoutNull.CheckedChanged -= chkCommentsWithoutNull_CheckedChanged;
                chkCommentsWithoutNull.Checked = IsCommentsWithoutNull;
                chkCommentsWithoutNull.CheckedChanged += chkCommentsWithoutNull_CheckedChanged;

                IsUsing = options.IsUsing;
                chkUsing.CheckedChanged -= chkUsing_CheckedChanged;
                chkUsing.Checked = IsUsing;
                chkUsing.CheckedChanged += chkUsing_CheckedChanged;
                ...
                txtInherit.TextChanged -= txtInherit_TextChanged;
                txtInherit.Text = Inherit;
                txtInherit.TextChanged += txtInherit_TextChanged;

                IsNewLineBetweenMembers = options.IsNewLineBetweenMembers;
                chkNewLineBetweenMembers.CheckedChanged -= chkNewLineBetweenMembers_CheckedChanged;
                chkNewLineBetweenMembers.Checked = IsNewLineBetweenMembers;
                chkNewLineBetweenMembers.CheckedChanged += chkNewLineBetweenMembers_CheckedChanged;
                ...
                chkNavigationProperties.CheckedChanged -= chkNavigationProperties_CheckedChanged;
                chkNavigationProperties.Checked = IsNavigationProperties;
                chkNavigationProperties.CheckedChanged += chkNavigationProperties_CheckedChanged;

                IsNavigationPropertiesVirtual = options.IsNavigationPropertiesVirtual;
                chkNavigationPropertiesVirtual.CheckedChanged -= chkNavigationPropertiesVirtual_CheckedChanged;
                chkNavigationPropertiesVirtual.Checked = IsNavigationPropertiesVirtual;
                chkNavigationPropertiesVirtual.CheckedChanged += chkNavigationPropertiesVirtual_CheckedChanged;

                IsNavigationPropertiesShowJoinTable = options.IsNavigationPropertiesShowJoinTable;
                chkNavigationPropertiesShowJoinTable.CheckedChanged -= chkNavigationPropertiesShowJoinTable_CheckedChanged;
                chkNavigationPropertiesShowJoinTable.Checked = IsNavigationPropertiesShowJoinTable;
                chkNavigationPropertiesShowJoinTable.CheckedChanged += chkNavigationPropertiesShowJoinTable_CheckedChanged;

                IsNavigationPropertiesComments = options.IsNavigationPropertiesComments;
                chkNavigationPropertiesComments.CheckedChanged -= chkNavigationPropertiesComments_CheckedChanged;
                chkNavigationPropertiesComments.Checked = IsNavigationPropertiesComments;
                chkNavigationPropertiesComments.CheckedChanged += chkNavigationPropertiesComments_CheckedChanged;

                IsNavigationPropertiesList = options.IsNavigationPropertiesList;
                rdbNavigationPropertiesList.CheckedChanged -= rdbNavigationPropertiesList_CheckedChanged;
                rdbNavigationPropertiesList.Checked = IsNavigationPropertiesList;
                rdbNavigationPropertiesList.CheckedChanged += rdbNavigationPropertiesList_CheckedChanged;

                IsNavigationPropertiesICollection = options.IsNavigationPropertiesICollection;
                rdbNavigationPropertiesICollection.CheckedChanged -= rdbNavigationPropertiesICollection_CheckedChanged;
                rdbNavigationPropertiesICollection.Checked = IsNavigationPropertiesICollection;
                rdbNavigationPropertiesICollection.CheckedChanged += rdbNavigationPropertiesICollection_CheckedChanged;

                IsNavigationPropertiesIEnumerable = options.IsNavigationPropertiesIEnumerable;
                rdbNavigationPropertiesIEnumerable.CheckedChanged -= rdbNavigationPropertiesIEnumerable_CheckedChanged;
                rdbNavigationPropertiesIEnumerable.Checked = IsNavigationPropertiesIEnumerable;
                rdbNavigationPropertiesIEnumerable.CheckedChanged += rdbNavigationPropertiesIEnumerable_CheckedChanged;

                IsSingular = options.IsSingular;
                chkSingular.CheckedChanged -= chkSingular_CheckedChanged;
                chkSingular.Checked = IsSingular;
                chkSingular.CheckedChanged += chkSingular_CheckedChanged;

                IsIncludeDB = options.IsIncludeDB;
                chkIncludeDB.CheckedChanged -= chkIncludeDB_CheckedChanged;
                chkIncludeDB.Checked = IsIncludeDB;
                chkIncludeDB.CheckedChanged += chkIncludeDB_CheckedChanged;

                DBSeparator = options.DBSeparator;
                txtDBSeparator.TextChanged -= txtDBSeparator_TextChanged;
                txtDBSeparator.Text = DBSeparator;
                txtDBSeparator.TextChanged += txtDBSeparator_TextChanged;

                IsIncludeSchema = options.IsIncludeSchema;
                chkIncludeSchema.CheckedChanged -= chkIncludeSchema_CheckedChanged;
                chkIncludeSchema.Checked = IsIncludeSchema;
                chkIncludeSchema.CheckedChanged += chkIncludeSchema_CheckedChanged;

                IsIgnoreDboSchema = options.IsIgnoreDboSchema;
                chkIgnoreDboSchema.CheckedChanged -= chkIgnoreDboSchema_CheckedChanged;
                chkIgnoreDboSchema.Checked = IsIgnoreDboSchema;
                chkIgnoreDboSchema.CheckedChanged += chkIgnoreDboSchema_CheckedChanged;

                SchemaSeparator = options.SchemaSeparator;
                txtSchemaSeparator.TextChanged -= txtSchemaSeparator_TextChanged;
                txtSchemaSeparator.Text = SchemaSeparator;
                txtSchemaSeparator.TextChanged += txtSchemaSeparator_TextChanged;

                WordsSeparator = options.WordsSeparator;
                txtWordsSeparator.TextChanged -= txtWordsSeparator_TextChanged;
                txtWordsSeparator.Text = WordsSeparator;
                txtWordsSeparator.TextChanged += txtWordsSeparator_TextChanged;

                IsCamelCase = options.IsCamelCase;
                chkCamelCase.CheckedChanged -= chkCamelCase_CheckedChanged;
                chkCamelCase.Checked = IsCamelCase;
                chkCamelCase.CheckedChanged += chkCamelCase_CheckedChanged;

                IsUpperCase = options.IsUpperCase;
                chkUpperCase.CheckedChanged -= chkUpperCase_CheckedChanged;
                chkUpperCase.Checked = IsUpperCase;
                chkUpperCase.CheckedChanged += chkUpperCase_CheckedChanged;

                IsLowerCase = options.IsLowerCase;
                chkLowerCase.CheckedChanged -= chkLowerCase_CheckedChanged;
                chkLowerCase.Checked = IsLowerCase;
                chkLowerCase.CheckedChanged += chkLowerCase_CheckedChanged;
                ...
                chkSearchIgnoreCase.CheckedChanged -= chkSearchIgnoreCase_CheckedChanged;
                chkSearchIgnoreCase.Checked = IsSearchIgnoreCase;
                chkSearchIgnoreCase.CheckedChanged += chkSearchIgnoreCase_CheckedChanged;

                FixedClassName = options.FixedClassName;
                txtFixedClassName.TextChanged -= txtFixedClassName_TextChanged;
                txtFixedClassName.Text = FixedClassName;
                txtFixedClassName.TextChanged += txtFixedClassName_TextChanged;
                ...
                chkEFColumn.CheckedChanged -= chkEFColumn_CheckedChanged;
                chkEFColumn.Checked = IsEFColumn;
                chkEFColumn.CheckedChanged += chkEFColumn_CheckedChanged;

                IsEFRequired = options.IsEFRequired;
                chkEFRequired.CheckedChanged -= chkEFRequired_CheckedChanged;
                chkEFRequired.Checked = IsEFRequired;
                chkEFRequired.CheckedChanged += chkEFRequired_CheckedChanged;

                IsEFRequiredWithErrorMessage = options.IsEFRequiredWithErrorMessage;
                chkEFRequiredWithErrorMessage.CheckedChanged -= chkEFRequiredWithErrorMessage_CheckedChanged;
                chkEFRequiredWithErrorMessage.Checked = IsEFRequiredWithErrorMessage;
                chkEFRequiredWithErrorMessage.CheckedChanged += chkEFRequiredWithErrorMessage_CheckedChanged;

                IsEFConcurrencyCheck = options.IsEFConcurrencyCheck;
                chkEFConcurrencyCheck.CheckedChanged -= chkEFConcurrencyCheck_CheckedChanged;
                chkEFConcurrencyCheck.Checked = IsEFConcurrencyCheck;
                chkEFConcurrencyCheck.CheckedChanged += chkEFConcurrencyCheck_CheckedChanged;

                IsEFStringLength = options.IsEFStringLength;
                chkEFStringLength.CheckedChanged -= chkEFStringLength_CheckedChanged;
                chkEFStringLength.Checked = IsEFStringLength;
                chkEFStringLength.CheckedChanged += chkEFStringLength_CheckedChanged;

                IsEFDisplay = options.IsEFDisplay;
                chkEFDisplay.CheckedChanged -= chkEFDisplay_CheckedChanged;
                chkEFDisplay.Checked = IsEFDisplay;
                chkEFDisplay.CheckedChanged += chkEFDisplay_CheckedChanged;

                IsEFDescription = options.IsEFDescription;
                chkEFDescription.CheckedChanged -= chkEFDescription_CheckedChanged;
                chkEFDescription.Checked = IsEFDescription;
                chkEFDescription.CheckedChanged += chkEFDescription_CheckedChanged;

                IsEFComplexType = options.IsEFComplexType;
                chkEFComplexType.CheckedChanged -= chkEFComplexType_CheckedChanged;
                chkEFComplexType.Checked = IsEFComplexType;
                chkEFComplexType.CheckedChanged += chkEFComplexType_CheckedChanged;

                IsEFIndex = options.IsEFIndex;
                chkEFIndex.CheckedChanged -= chkEFIndex_CheckedChanged;
                chkEFIndex.Checked = IsEFIndex;
                chkEFIndex.CheckedChanged += chkEFIndex_CheckedChanged;

                IsEFForeignKey = options.IsEFForeignKey;
                chkEFForeignKey.CheckedChanged -= chkEFForeignKey_CheckedChanged;
                chkEFForeignKey.Checked = IsEFForeignKey;
                chkEFForeignKey.CheckedChanged += chkEFForeignKey_CheckedChanged;
